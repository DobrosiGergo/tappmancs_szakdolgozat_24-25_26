<x-app-layout>
  <section class="max-w-7xl mx-auto px-6 pb-16 pt-8">
    ...
    <div class="mb-8">
      ...
      <p class="mt-1 text-sm text-neutral-500">Add meg az alapadatokat, majd töltsd fel a kisállat képeit.</p>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-[3fr_2fr] gap-8 items-start">
      ...
      <div class="lg:sticky lg:top-6 bg-white rounded-3xl shadow-sm border border-neutral-200 p-6 lg:p-8">
        <div class="mb-5">
          ...
          <p class="mt-1 text-sm text-neutral-500">Tölts fel akár 10 képet a kisállatról.</p>
        </div>
